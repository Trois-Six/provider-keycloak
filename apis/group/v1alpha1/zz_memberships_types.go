...
type MembershipsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/trois-six/provider-keycloak/apis/keycloak/v1alpha1.User
	// +listType=set
	Members []*string `json:"members,omitempty" tf:"members,omitempty"`

	// References to User in keycloak to populate members.
	// +kubebuilder:validation:Optional
	MembersRefs []v1.Reference `json:"membersRefs,omitempty" tf:"-"`

	// Selector for a list of User in keycloak to populate members.
	// +kubebuilder:validation:Optional
